      ...
      <article class="project-card reveal flex flex-col md:flex-row gap-12 md:gap-20 items-center mb-32 md:mb-44">
        ...
        <div class="w-full md:w-2/5 flex flex-col items-start">
          <div class="flex items-center gap-4 mb-6">
            ...
            <span class="px-3 py-1 border border-emerald-500/30 bg-emerald-500/10 rounded-full text-[10px] text-emerald-400 tracking-widest uppercase font-medium">Em Produção</span>
          </div>
